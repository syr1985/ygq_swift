...
class NTFocusProductViewCell: UITableViewCell {
    ...
    @IBOutlet weak fileprivate var productImage: UIImageView!
    @IBOutlet weak fileprivate var buyNumber: UILabel!
    ...
    var model: NTHomeFocusModel {
        didSet {
            ...
            buyNumber.text = "\(model.buyCount)人购买"
            productImage.af_setImage(withURL: URL.init(string: model.imageUrl)!)
        }
    }
